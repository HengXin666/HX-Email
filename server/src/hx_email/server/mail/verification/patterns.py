...
CONTEXT_TERMS: tuple[str, ...] = (
    ...
    "güvenlik kodu",
    "tek kullanımlık kod",
    # 2026-08-15: MS verification emails in Indonesian (Kode keamanan) were
    # returning None -> "waiting for security code timeout". Add id/ms/vi/th/
    # nordic/central-european terms so the code gets context scoring.
    "kode keamanan",
    "kode verifikasi",
    "kode konfirmasi",
    "kode otp",
    ...
    "turvakoodi",
    "vahvistuskoodi",
    # 捷克语 / 匈牙利语 / 罗马尼亚语 / 希腊语 / 乌克兰语 / 希伯来语 / 印地语
    "bezpečnostní kód",
    "bezpecnostni kod",
    "ověřovací kód",
    "overovaci kod",
