...
export const IconGithub: React.FC<IconProps> = (p) => {
  const { size = 16, className = '', style } = p
  return (
    <svg
      width={size}
      height={size}
...
export const IconFolderPlus: React.FC<IconProps> = (p) => (
  <Svg {...p}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
...
export const IconMoreVertical: React.FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const IconAt: React.FC<IconProps> = (p) => (
  <Svg {...p}>
